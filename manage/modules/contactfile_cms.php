...
{  
    ...
    {
        $chktitle=$db->getVal("select title from  contactfile_cms where title='".trim($_POST['title'])."'");
        if($chktitle=='')
        {
    ...
    {
        $chktitle=$db->getVal("select title from  contactfile_cms where title='".trim($_POST['title'])."' && cms_id!='".$_GET['id']."'");
        if($chktitle=='')
        {
            $linkname= seo_url($_POST['title']);
            $aryData = array(
            ...
            if($_FILES["image"]["error"]==0)
            {
                ...
                if(in_array($ext,array('jpeg','jpg','gif','png')))
                {
                    $imgi = $db->getVal("select image from  contactfile_cms where cms_id = '".$_GET['id']."'");
            ...
            $flgUp = $db->updateAry(" contactfile_cms", $aryData, "where cms_id='".$_GET['id']."'");
            if (!is_null($flgUp))
            {
                $_SESSION['msg'] = 'Saved Successfully';
                unset($_SESSION['form']);
...
elseif ($pgAct == "delete" && isset($_GET['id']) && trim($_GET['id']) != '') 
{
    ...
    @unlink("../uploads/cms/$imgi");
    @unlink("../uploads/cms/100x100/$imgi");
    $res=$db->delete(' contactfile_cms',"where cms_id='".$_GET['id']."'"); 
    if(!is_null($res))
    {
...
<div class="row">
    <div class="col-md-12"> 
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li><a href="<?php echo URL_ROOT; ?>/manage/?module=<?=$_GET['module'].'&section='.$_GET['section']?>">Contact Queries</a></li> 
        </ul>
...
if ($pgAct == "add" || ($pgAct == "edit" && isset($_GET['id']) && trim($_GET['id']) != '')) 
{
    ...
    {
        $aryForm = $db->getRow("SELECT * FROM  contactfile_cms WHERE cms_id='" . $_GET['id'] . "'");
    }
                            ...
                            <form class="form-horizontal" enctype="multipart/form-data" method="post" id="myForm">
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-7">
                                            <input type='text' name="small_title" id="small_title" class="form-control" value='<?php if($_POST) { echo trim($_POST['small_title']);}else { echo $aryForm['small_title'];} ?>' placeholder="Enter Sub Title">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-7">
                                       <textarea id="description" rows='7' class="form-control tinymce required"   name="description"><?php if($_POST) { echo trim($_POST['description']);}else { echo ucfirst(stripslashes($aryForm['description']));} ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
...
{
    $aryForm=$db->getRow("SELECT * FROM  contactfile_cms WHERE cms_id='".(int)$_GET['id']."'");
    ?>
    <div class="portlet">
        <div class="portlet-title">
            <div class="caption">
            ...
            <form role="form" class="form-horizontal">
                <div class="form-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <p class="form-control-static">
                                    <?php echo ucfirst($aryForm['email']); ?>
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <p class="form-control-static">
                                    <?php echo ucfirst($aryForm['phone']); ?>
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="control-label col-md-3">Cover Later :</label>
                                <div class="col-md-9">
                                    <p class="form-control-static">
                                    <?php echo ucfirst($aryForm['cover']); 
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="control-label col-md-3">Contact Files:</label>
                                <div class="col-md-9">
                                    <p class="form-control-static">
                                    <?php 
                                    if($aryForm['image']!='' && file_exists("../uploads/cms/".$aryForm['image']))
                                    {
                                        ?>
                                        <a target="blank" href="<?php echo URL_ROOT ?>uploads/cms/<?php echo $aryForm['image'] ?>">Click to View</a>
                                        <?php
                                    }
                                    ?>
                                    </p>
...
{
    $sqlLimit = "SELECT * FROM   contactfile_cms ORDER BY cms_id DESC";

...
<div class="wrap container" role="document">
  ...
  <h3 class="event-subtitle"><?=$schedule['small_title'] ?></h3>  <p><strong><?=$schedule['date'] ?> at <?=$schedule['time'] ?> <?=$schedule['mer'] ?>&nbsp; | &nbsp;<?=$schedule['venue'] ?></strong></p>
  <div class="row share">
    <div class="col-sm-3">
      <div class="row">
...
<div class="row single-event-content">
  <aside class="col-sm-5 pull-right">
    <img width="2772" height="1641" src="./uploads/cms/<?=$schedule['image'] ?>" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" loading="lazy"  sizes="(max-width: 2772px) 100vw, 2772px">  </aside>
  <article class="col-sm-7">
    <p><?=$schedule['description'] ?></p> 

          <h3>Ticket Information:</h3>
              <a href="" target="_blank" class="btn-blue">Buy Tickets</a>
              <h3>Venue Information:</h3>
      <p><?=$schedule['venue'] ?><br></p> 
              <div class="google-maps">
          <iframe src="<?=$schedule['map_link'] ?>" width="400" height="300" frameborder="0" style="border:0" allowfullscreen></iframe>        </div>
            </article>
</div> 
